...
?>
	...
	/* Please set here for showing login form, stats and our impact */
			...
			{
				// If the $page == 1 and $_GET['sel'] == 1 or 2 don't load left sidebar and $_GET['redesign'] exist in the url.
				if( ! ( isset($_GET['sel']) && $page == 1 && isset($_GET['redesign']) && ($_GET['sel'] == 1 || $_GET['sel'] == 2) ))
				{
