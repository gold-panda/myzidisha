...
function mailSender ( $hdr_from, $hdr_to, $email, $subject, $body, $attachment='',$templet = 0,$html=0,$info=0) {
/*
...
*/
	...
	$mime->_build_params['html_charset'] = 'ISO-8859-1';//get_lang('mail_html_charset');
	$mime->_build_params['text_charset'] = 'ISO-8859-1';//get_lang('mail_text_charset');
	$mime->_build_params['head_charset'] = 'ISO-8859-1';// get_lang('mail_head_charset');
	...
	if (MAIL_FORMAT == 'text') {
		...
		$cssfile =ROOT_DIR.'css/default/style.css';
