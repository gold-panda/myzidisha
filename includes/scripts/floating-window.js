...
************************************************************************************************************/
	...
	*/	
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = 'includes/scripts/images/top_left.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = 'includes/scripts/images/top_center.gif';
		...
		var img = document.createElement('IMG');
		img.src = 'includes/scripts/images/minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = 'includes/scripts/images/close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = 'includes/scripts/images/top_right.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = 'includes/scripts/images/bottom_right.gif';
	...
	{		
		...
		document.getElementById('windowContent' + divId).innerHTML = '<br/><img src ="includes/scripts/images/fetching.gif">';
