...
?>
	...
	<div align='left' class='static'><h2>Donate</h2></div>
	...
	<p>Residents of all countries may make donations via credit card or PayPal using the button below.</p><br/>
	...
	<p>Please note that if you choose this option, both the sending bank and our receiving bank will deduct transfer fees from the amount credited to your lender account. The fee amounts vary depending on the sending bank, and can add up to USD 50 or more for a single transaction.</p>
