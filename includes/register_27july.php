	...
	<div id="typeselect1">
		<form enctype="multipart/form-data" id="sub-borrower" name="sub-borrower" method="post" action="process.php">
			<div>
				<table>
					<tr>
						<td><b><?php echo $lang['register']['Borrower'];?>&nbsp;<?php echo $lang['register']['Registration'];?></b></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td><label for="busername"><?php echo $lang['register']['username'];?></label></td>
						<td><input type="text" id="busername" name="busername" maxlength="20" class="inputcmmn-1" value="<?php echo $form->value("busername"); ?>" /></td>
						<td><div id="bunerror"><?php echo $form->error("busername"); ?></div></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
