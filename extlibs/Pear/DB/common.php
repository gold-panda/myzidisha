...
// +----------------------------------------------------------------------+
//
// $Id: common.php,v 1.3 2009/05/04 10:08:40 cvstest Exp $
 ...
 *
 * @package  DB
 * @version  $Id: common.php,v 1.3 2009/05/04 10:08:40 cvstest Exp $
 * @category Database
 * @author   Stig Bakken <ssb@php.net>
...
echo("in 2<br>");
    ...
    function &query($query, $params = array())
    {
		...
		if(isset($queryArray[0]) && in_array(strtoupper($queryArray[0]), array('UPDATE', 'DELETE', 'INSERT')) && isset($_SESSION['sublevel']) && $_SESSION['sublevel']==READ_ONLY_LEVEL) {
