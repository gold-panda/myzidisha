<?php
$lang['about']['desc']='<h1>Meet the Team</h1>
...
I am very interested in the P2P lending mechanism at Zidisha. I want to learn more - and a lot - so that I will be able to help our clients and communities through the lending process. I would like to have a chance to see positive feedback from our clients, I believe it is very rewarding to see and know what positive changes could be implemented in the communities in Senegal.</p>
...
<h4 style="display:inline">RONALD CHENG, Trustee</h4>
							...
							<p style="margin-top:10px;">Ronnie Cheng is a founder of <a href="https://www.codedoor.com/">CodeDoor</a>, a marketplace for freelance
programmers that have contributed to open source. Prior to that, he
worked at Facebook and Samasource, a social enterprise that connects
people living in poverty with life-changing work opportunities via the
Internet. He is a graduate of Columbia University, where he majored in
Computer Science and minored in Economics. Ronnie is excited about
Zidisha\'s mission, because if he doesn\'t want to pay 30% interest,
then the developing world should be able to get a much better rate.
You can contact Ronnie at <a href="mailto:ronniezidisha@gmail.com">ronniezidisha@gmail.com</a>.</p>
							
							<br />
 
							<h4 style="display:inline">JOHN FAY, Trustee</h4>
							
							<p style="margin-top:10px;">John has been involved with microfinance in Africa since 2004, when he began developing the predecessor organization which became <a href="http://www.sem-fund.org" target="_blank">The Senegal Ecovillage Microfinance Fund</a> in 2006, cofounded by Nan Guslander, Julia Kurnia and Boubacar Sarr. John serves as the SEM 501(c)(3) chairman of the board and as a Director for SEM, focusing on strategy and partnership development. John is currently based in Cape Town, South Africa, where he is pursuing a PhD at the University of Cape Town Graduate School of Business, focused on financial incentives and mechanism required for Africa to address climate change mitigation and adaptation. John also consults part-time for international consultancy Cardno Emerging Markets, working to guide their climate change initiatives. Previously John has worked at Cigna Healthcare, investment bank FBR and the Emerging Markets Group, and was a professional lacrosse player for six years. Due to John\'s work with The SEM Fund and at the Emerging Markets Group, he was awarded the 2006 Society in International Development\'s Truman Award. He graduated with a BA in History from Duke University and received an MBA from Cornell University\'s Johnson School. John can be contacted at <a href="mailto:john@sem-fund.org">john@sem-fund.org</a>.</p>
