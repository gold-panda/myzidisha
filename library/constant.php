...
// See http://stackoverflow.com/questions/7336861/how-to-convert-string-to-boolean-php
define("COOKIE_SECURE", filter_var($_SERVER["ENV_COOKIE_SECURE"], FILTER_VALIDATE_BOOLEAN));
