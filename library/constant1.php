...
define ("TBL_LOANAPPLIC", "loanapplic");//Transaction Types//user level configuration
...
define("EMAIL_FROM_ADDR", "noreply@zidisha.org");//this used in registration emails as sender email address
...
Define ('DEFAULT_IMAGE', 'file:dimg.jpg');  Define ('SITE_URL', 'https://www.zidisha.org/');
// paths
