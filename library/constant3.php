...
//websites addresses
define("EMAIL_FROM_NAME", "Zidisha Desk");//this used in registration emails as sender name
define("EMAIL_FROM_ADDR", "info@zidisha.org");//this used in registration emails as sender email address
define("EMAIL_WELCOME", true);

//web administrator email addresses
define("ADMIN_FROM_NAME", "Zidisha Administrator");//this used in emails as sender name
define("ADMIN_EMAIL_ADDR", "info@zidisha.org");//this used in emails as sender email
define("WEBSITE_ADDRESS", "http://www.zidisha.org/index.php");// this used in emails to again reach to a specific page 
...
Define ('WATERMARK_TEXT',		'Zidisha');// text displayed on uploaded pics 
Define ('DEFAULT_IMAGE', 'file:dimg.jpg');  Define ('SITE_URL', 'http://www.zidisha.org/');
// paths
...
define(PAYPAL_ACCOUNT, "lenders@zidisha.org");
/*
use curl for paypal
*/
